...
from chatchat.webui_pages.feedback.feedback_page import feedback_page, view_feedback_page
...
if __name__ == "__main__":
    ...
    if selected_page == "Knowledge Base Management":
        ...
        kb_chat(api=api)
    elif selected_page=="Feedback Review":
        view_feedback_page()
    else:
